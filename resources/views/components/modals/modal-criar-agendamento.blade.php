...
<div x-show="openCreate" class="fixed inset-0 z-50 flex items-center justify-center bg-black/40" style="display: none;">
    <div class="bg-white rounded-xl shadow-xl p-8 w-full max-w-md relative">
        ...
        <form action="{{ route('appointments.store') }}" method="POST">
            ...
            <div class="mb-4">
                <label for="scheduled_at" class="block text-sm font-medium text-gray-700">Date and Time</label>
            ...
            <div class="flex justify-end gap-2 mt-6">
                <button type="button" @click="openCreate = false" class="px-4 py-2 bg-gray-100 text-gray-800 rounded hover:bg-gray-200 border border-gray-200">Cancel</button>
                <button type="submit" class="px-4 py-2 bg-blue-100 text-blue-800 rounded hover:bg-blue-200 border border-blue-200">Save</button>
            </div>
        </form>
    </div>
</div>
