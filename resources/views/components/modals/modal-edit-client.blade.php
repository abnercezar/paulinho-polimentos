    ...
    <div x-show="openEdit === {{ $client->id }}" class="fixed inset-0 z-50 flex items-center justify-center bg-black/40" style="display: none;">
        <div class="bg-white rounded-xl shadow-xl p-8 w-full max-w-md relative">
            ...
            <form action="{{ route('clients.update', $client->id) }}" method="POST">
                ...
                @method('PUT')
                <div class="mb-4">
                    <label for="edit_name_{{ $client->id }}" class="block text-sm font-medium text-gray-700">Name</label>
                ...
                <div class="mb-4">
                    <label for="edit_phone_{{ $client->id }}" class="block text-sm font-medium text-gray-700">Phone</label>
